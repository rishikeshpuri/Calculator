...
const currrentOperandTextElement = document.querySelector("[data-curr-operand]");
...
document.addEventListener('DOMContentLoaded', ()=> {
  const calc = new Calculator(previousOperantTextElement,currrentOperandTextElement);
